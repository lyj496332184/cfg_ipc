...
static int fdevent_select_reset(cfg_fdevents *ev)
{
...
static int fdevent_select_event_del(cfg_fdevents *ev, int fde_ndx, int fd)
{
	UNUSED(fde_ndx);
...
static int fdevent_select_event_set(cfg_fdevents *ev, int fde_ndx, int fd, int events)
{
	UNUSED(fde_ndx);
...
static int fdevent_select_poll(cfg_fdevents *ev, int timeout_ms)
{
	struct timeval tv;
...
static int fdevent_select_event_get_revent(cfg_fdevents *ev, size_t ndx)
{
	int revents = 0;
...
static int fdevent_select_event_get_fd(cfg_fdevents *ev, size_t ndx)
{
	UNUSED(ev);
...
static int fdevent_select_event_next_fdndx(cfg_fdevents *ev, int ndx)
{
	int i;
